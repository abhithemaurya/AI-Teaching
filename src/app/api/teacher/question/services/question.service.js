...
export const updateGeneratedQuestionService=
  async(id,questions)=>{
    return await questionRepository.updategeneratedQustion(
      id,questions
    )
  }

export const deleteGeneratedQuestionService=
async(id,teacherId)=>{
  return await questionRepository.deleteGeneratedQuestion(
    id,teacherId
  )
}
